...
percs <- melt(sqds[,.(
                ...
                overseas=(.N - sum(flag==country, flag==''))/.N,
                unknown=sum(flag=='')/.N), 
              by='year'], 
...
It is quite clear then, from Figure \@ref(fig:overseas-percs), that the percentage of players playing their club rugby abroad has greatly increased. The increase is quite evident between 1995-'99 when the game went "open", and although it appears that the number of overseas players in squads may be falling the number of unknowns has increased and makes it hard to draw any significant conclusions about recent union directives, such as the "Giteau Rule" implemented by Australia, which keep all but the mos senior members of squads from representing their home country whilst playing abroad the rest of the time. 
...
So Figure \@ref(fig:poaching-percs) would make it look like the leagues in the Tier 1 nations have been increasingly luring away the Tier 2 stars with bigger pay packets; again expounding on this discussion is for another day. 

It is also clear that data for Tier 3 players is hard to come by, or at the very least, those clubs are not big enough to merit a Wikipedia entry!
